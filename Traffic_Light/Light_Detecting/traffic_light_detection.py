...
class FrameProcessor():
    ...
    # Grab relevant frame part
        ...
        blob_keypoints = filter(
            lambda blob: self.classifier.predict(self.get_traffic_light_from_keypoint(color_image, blob)) == self.RED_LIGHT_CLASS, 
            blob_keypoints
        )
        ...
        show_lights = [rl.keypoint for rl in filter(lambda rlc: rlc.gteq_threshold, self.red_lights)]
